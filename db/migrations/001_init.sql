-- HelixMCP BioMCP Fabric (Postgres) - initial schema
...
CREATE INDEX artifacts_checksum_idx ON artifacts(checksum_sha256);
...
CREATE INDEX runs_tool_idx ON runs(tool_name);
